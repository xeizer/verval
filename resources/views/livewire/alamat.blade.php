        ...
        <div class="row justify-content-center mb-2">
            ...
            <div class="col-md-12 mb-2">
                <div class="row">
                    ...
                    <div class="col">
                        <a href="{{ route('biodata') }}" class="p-1 w-100 btn btn-primary">Bio</a>
                    </div>
                    <div class="col">
                        <a href="{{ route('alamat') }}" class="p-1 w-100 btn btn-secondary">Alamat</a>
                    </div>
                    <div class="col">
                        <a href="" class="p-1 w-100 btn btn-outline-primary">Ayah</a>
                    </div>
                    <div class="col">
                        <a href="" class="p-1 w-100 btn btn-outline-primary">Ibu</a>
                    </div>
                    <div class="col">
                        <a href="" class="p-1 w-100 btn btn-outline-primary">Wali</a>
                    </div>
